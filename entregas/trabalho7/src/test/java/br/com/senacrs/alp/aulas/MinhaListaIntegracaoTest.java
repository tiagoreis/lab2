...
public class MinhaListaIntegracaoTest {
	...
	private <Tipo> MinhaLista<Tipo> criarMinhaLista() {
		
		MinhaLista<Tipo> resultado = null;
	...
	private <Tipo> Tipo buscarSufixo(MinhaLista<Tipo> lista) {
	...
	private <Tipo> Tipo buscarPrefixo(MinhaLista<Tipo> lista) {
	...
	private <Tipo> void encadearValores(MinhaLista<Tipo> lista, Tipo[] valores) {
	...
	private <Tipo> boolean existeValorNaLista(MinhaLista<Tipo> lista, Tipo valor) {
